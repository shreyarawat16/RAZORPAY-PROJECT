...
export default function Navbar(){
  return (
    <>
        ...
        <img                   
        className='h-12 w-40 border border-white-100'
        src={Assets.logo}/> 
        </a>
            ...
            <li className="hover:text-blue-500 cursor-pointer
             ...
             <div className="flex space-x-6">
                ...
                <img src={Assets.Flag} className="h-10 w-full"></img>
                  ...
                  <button className="text-white font-bold border border-blue-200 cursor-pointer py-3 px-5 rounded-md hover:bg-blue-700 transition-all duration-200 bg-blue-600">
                   Sign Up
                  </button>
